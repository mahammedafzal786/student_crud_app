...
{
	public  static String sendMail(String recipientEmail) 
	{
		// Recipient's email ID
//        String recipientEmail  = recipientEmail;
        // Sender's email ID and password
        final String senderEmail = "afzalkhaliddiwan2003@gmail.com";
        final String senderPassword = "iohd dpyy ltfz hffd";
    ...
    public static void main(String[] args) 
    {
    	...
    	String recipientEmail = sc.nextLine();
     	...
     	String otp =  sendMail(recipientEmail);
    	
        System.out.println("OTP mailed : "+otp);
    }
